...
We did this in class, so I chose not to write it out again.
...
Once again, we talked about this in class.
...
The program stops running when it calls execle the first time, thus never finishing the loop. Oh no!
